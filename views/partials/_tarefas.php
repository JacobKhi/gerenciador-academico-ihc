<section class="add-task-section">
    ...
    <form action="processa_acoes.php" method="POST" class="add-task-form">
        ...
        <ul class="tasks-list">
            <?php foreach ($tarefas as $tarefa): ?>
                <li class="task-item <?php echo $tarefa['concluida'] ? 'completed' : ''; ?>">
                    ...
                    <a href="processa_acoes.php?action=delete_task&id=<?php echo $tarefa['id']; ?>" class="delete-task-link" title="Apagar Tarefa">
                        &#128465;
                    </a>
                </li>
            <?php endforeach; ?>
